...
This project implements an end-to-end TinyML pipeline for real-time speech command recognition using an ESP32C3 + INMP441 microphone, powered by a 2D CNN trained on MFCC features.
