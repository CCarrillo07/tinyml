...
/* =========================
   PIN CONFIGURATION
   ========================= */
#define PIN_NUM_SCLK    8    // SPI clock (SCK)
#define PIN_NUM_MOSI    10   // SPI MOSI (data to display)
#define PIN_NUM_MISO    -1   // Not used (display is write-only)
#define PIN_NUM_DC      2    // Data/Command control pin
#define PIN_NUM_RST     3    // Reset pin for the display
#define PIN_NUM_CS      7    // Chip select pin
